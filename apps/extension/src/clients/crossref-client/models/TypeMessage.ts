...
/**
 * Check if a given object implements the TypeMessage interface.
 */
export function instanceOfTypeMessage(value: object): value is TypeMessage {
...
export function TypeMessageFromJSON(json: any): TypeMessage {
    return TypeMessageFromJSONTyped(json, false);
}

export function TypeMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): TypeMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': TypeFromJSON(json['message']),
    };
}

export function TypeMessageToJSON(json: any): TypeMessage {
    return TypeMessageToJSONTyped(json, false);
}

export function TypeMessageToJSONTyped(value?: TypeMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': TypeToJSON(value['message']),
    };
}
