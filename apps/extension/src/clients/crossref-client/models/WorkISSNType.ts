...
/**
 * Check if a given object implements the WorkISSNType interface.
 */
export function instanceOfWorkISSNType(value: object): value is WorkISSNType {
...
export function WorkISSNTypeToJSON(json: any): WorkISSNType {
    return WorkISSNTypeToJSONTyped(json, false);
}

export function WorkISSNTypeToJSONTyped(value?: WorkISSNType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
