 ...
 * 
 * @export
 * @interface WorkAssertionGroup
 */
export interface WorkAssertionGroup {
    /**
     * 
     * @type {string}
     * @memberof WorkAssertionGroup
     */
    name: string;
    /**
     * 
...
/**
 * Check if a given object implements the WorkAssertionGroup interface.
 */
export function instanceOfWorkAssertionGroup(value: object): value is WorkAssertionGroup {
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function WorkAssertionGroupFromJSON(json: any): WorkAssertionGroup {
    return WorkAssertionGroupFromJSONTyped(json, false);
}

export function WorkAssertionGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkAssertionGroup {
    if (json == null) {
        return json;
    }
    return {
...
export function WorkAssertionGroupToJSON(json: any): WorkAssertionGroup {
    return WorkAssertionGroupToJSONTyped(json, false);
}

export function WorkAssertionGroupToJSONTyped(value?: WorkAssertionGroup | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
