...
/**
 * Check if a given object implements the WorkLicense interface.
 */
export function instanceOfWorkLicense(value: object): value is WorkLicense {
    if (!('uRL' in value) || value['uRL'] === undefined) return false;
    if (!('delayInDays' in value) || value['delayInDays'] === undefined) return false;
...
export function WorkLicenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkLicense {
    ...
    return {
        ...
        'uRL': json['URL'],
        'start': json['start'] == null ? undefined : ModelDateFromJSON(json['start']),
        'delayInDays': json['delay-in-days'],
        'contentVersion': json['content-version'],
    };
}

export function WorkLicenseToJSON(json: any): WorkLicense {
    return WorkLicenseToJSONTyped(json, false);
}

export function WorkLicenseToJSONTyped(value?: WorkLicense | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
