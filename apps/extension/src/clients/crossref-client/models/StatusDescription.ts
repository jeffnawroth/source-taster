...
/**
 * Check if a given object implements the StatusDescription interface.
 */
export function instanceOfStatusDescription(value: object): value is StatusDescription {
    return true;
}

export function StatusDescriptionFromJSON(json: any): StatusDescription {
    return StatusDescriptionFromJSONTyped(json, false);
}

export function StatusDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusDescription {
    if (json == null) {
        return json;
    }
    return {
...
export function StatusDescriptionToJSON(json: any): StatusDescription {
    return StatusDescriptionToJSONTyped(json, false);
}

export function StatusDescriptionToJSONTyped(value?: StatusDescription | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
