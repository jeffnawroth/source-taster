...
/**
 * Check if a given object implements the WorkReview interface.
 */
export function instanceOfWorkReview(value: object): value is WorkReview {
    return true;
}
...
export function WorkReviewFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkReview {
    ...
    return {
        ...
        'runningNumber': json['running-number'] == null ? undefined : json['running-number'],
        'revisionRound': json['revision-round'] == null ? undefined : json['revision-round'],
        'stage': json['stage'] == null ? undefined : json['stage'],
        'competingInterestStatement': json['competing-interest-statement'] == null ? undefined : json['competing-interest-statement'],
        'recommendation': json['recommendation'] == null ? undefined : json['recommendation'],
        'language': json['language'] == null ? undefined : json['language'],
    };
}

export function WorkReviewToJSON(json: any): WorkReview {
    return WorkReviewToJSONTyped(json, false);
}

export function WorkReviewToJSONTyped(value?: WorkReview | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
