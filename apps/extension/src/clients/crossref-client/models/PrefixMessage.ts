...
/**
 * Check if a given object implements the PrefixMessage interface.
 */
export function instanceOfPrefixMessage(value: object): value is PrefixMessage {
...
export function PrefixMessageFromJSON(json: any): PrefixMessage {
    return PrefixMessageFromJSONTyped(json, false);
}

export function PrefixMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrefixMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': PrefixFromJSON(json['message']),
    };
}

export function PrefixMessageToJSON(json: any): PrefixMessage {
    return PrefixMessageToJSONTyped(json, false);
}

export function PrefixMessageToJSONTyped(value?: PrefixMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': PrefixToJSON(value['message']),
    };
}
