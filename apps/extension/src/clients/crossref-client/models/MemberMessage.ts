...
/**
 * Check if a given object implements the MemberMessage interface.
 */
export function instanceOfMemberMessage(value: object): value is MemberMessage {
...
export function MemberMessageFromJSON(json: any): MemberMessage {
    return MemberMessageFromJSONTyped(json, false);
}

export function MemberMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': MemberFromJSON(json['message']),
    };
}

export function MemberMessageToJSON(json: any): MemberMessage {
    return MemberMessageToJSONTyped(json, false);
}

export function MemberMessageToJSONTyped(value?: MemberMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': MemberToJSON(value['message']),
    };
}
