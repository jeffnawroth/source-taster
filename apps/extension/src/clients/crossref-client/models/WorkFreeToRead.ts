...
/**
 * Check if a given object implements the WorkFreeToRead interface.
 */
export function instanceOfWorkFreeToRead(value: object): value is WorkFreeToRead {
    return true;
}
...
export function WorkFreeToReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkFreeToRead {
    ...
    return {
        ...
        'startDate': json['start-date'] == null ? undefined : DatePartsFromJSON(json['start-date']),
        'endDate': json['end-date'] == null ? undefined : DatePartsFromJSON(json['end-date']),
    };
}

export function WorkFreeToReadToJSON(json: any): WorkFreeToRead {
    return WorkFreeToReadToJSONTyped(json, false);
}

export function WorkFreeToReadToJSONTyped(value?: WorkFreeToRead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
