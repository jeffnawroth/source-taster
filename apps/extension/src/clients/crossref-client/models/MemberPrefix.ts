 ...
 * 
 * @export
 * @interface MemberPrefix
 */
export interface MemberPrefix {
    /**
     * 
     * @type {string}
     * @memberof MemberPrefix
     */
    name: string;
    /**
     * 
...
/**
 * Check if a given object implements the MemberPrefix interface.
 */
export function instanceOfMemberPrefix(value: object): value is MemberPrefix {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('value' in value) || value['value'] === undefined) return false;
    return true;
}

export function MemberPrefixFromJSON(json: any): MemberPrefix {
    return MemberPrefixFromJSONTyped(json, false);
}

export function MemberPrefixFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberPrefix {
    if (json == null) {
        return json;
    }
    return {
...
export function MemberPrefixToJSON(json: any): MemberPrefix {
    return MemberPrefixToJSONTyped(json, false);
}

export function MemberPrefixToJSONTyped(value?: MemberPrefix | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
