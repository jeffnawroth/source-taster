...
export interface FundersArray {
    ...
    /**
     * 
     * @type {Array<FunderSchema>}
     * @memberof FundersArray
     */
    results?: Array<FunderSchema>;
}
...
export function FundersArrayFromJSON(json: any): FundersArray {
    return FundersArrayFromJSONTyped(json, false);
}

export function FundersArrayFromJSONTyped(json: any, ignoreDiscriminator: boolean): FundersArray {
    if (json == null) {
        return json;
    }
    return {
