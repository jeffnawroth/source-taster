 ...
 * 
 * @export
 * @interface AuthorshipsInnerAuthor
 */
...
export function AuthorshipsInnerAuthorFromJSON(json: any): AuthorshipsInnerAuthor {
    return AuthorshipsInnerAuthorFromJSONTyped(json, false);
}

export function AuthorshipsInnerAuthorFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorshipsInnerAuthor {
    if (json == null) {
        return json;
    }
    return {
