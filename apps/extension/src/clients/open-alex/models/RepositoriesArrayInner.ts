 ...
 * 
 * @export
 * @interface RepositoriesArrayInner
 */
export interface RepositoriesArrayInner {
    /**
     * 
     * @type {string}
...
export function RepositoriesArrayInnerFromJSON(json: any): RepositoriesArrayInner {
    return RepositoriesArrayInnerFromJSONTyped(json, false);
}

export function RepositoriesArrayInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RepositoriesArrayInner {
    if (json == null) {
        return json;
    }
    return {
