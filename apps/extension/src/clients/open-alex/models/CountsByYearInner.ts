 ...
 * 
 * @export
 * @interface CountsByYearInner
 */
export interface CountsByYearInner {
    /**
     * 
     * @type {number}
...
export function CountsByYearInnerFromJSON(json: any): CountsByYearInner {
    return CountsByYearInnerFromJSONTyped(json, false);
}

export function CountsByYearInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountsByYearInner {
    if (json == null) {
        return json;
    }
    return {
