...
export function AuthorsFromJSON(json: any): Authors {
    return AuthorsFromJSONTyped(json, false);
}

export function AuthorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Authors {
    if (json == null) {
        return json;
    }
    return {
