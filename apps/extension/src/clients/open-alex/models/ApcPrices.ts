...
import type { ApcPricesInner } from './ApcPricesInner';
import {
    ApcPricesInnerFromJSON,
    ApcPricesInnerFromJSONTyped,
    ApcPricesInnerToJSON,
} from './ApcPricesInner';
 ...
 * @interface ApcPrices
 */
export interface ApcPrices extends Array<ApcPricesInner> {
}

/**
 * Check if a given object implements the ApcPrices interface.
 */
export function instanceOfApcPrices(value: object): value is ApcPrices {
    return true;
}
