 ...
 * 
 * @export
 * @interface InternationalDisplayNameAndDescription
 */
export interface InternationalDisplayNameAndDescription {
    /**
     * 
...
/**
 * Check if a given object implements the InternationalDisplayNameAndDescription interface.
 */
export function instanceOfInternationalDisplayNameAndDescription(value: object): value is InternationalDisplayNameAndDescription {
    return true;
}

export function InternationalDisplayNameAndDescriptionFromJSON(json: any): InternationalDisplayNameAndDescription {
    return InternationalDisplayNameAndDescriptionFromJSONTyped(json, false);
}

export function InternationalDisplayNameAndDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): InternationalDisplayNameAndDescription {
    if (json == null) {
        return json;
    }
    return {
