...
export interface Publishers {
    ...
    /**
     * 
     * @type {Array<PublisherSchema>}
     * @memberof Publishers
     */
    results: Array<PublisherSchema>;
}
...
export function PublishersFromJSON(json: any): Publishers {
    return PublishersFromJSONTyped(json, false);
}

export function PublishersFromJSONTyped(json: any, ignoreDiscriminator: boolean): Publishers {
    if (json == null) {
        return json;
    }
    return {
