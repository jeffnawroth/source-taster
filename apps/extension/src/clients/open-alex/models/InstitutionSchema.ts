...
export function InstitutionSchemaToJSON(json: any): InstitutionSchema {
    return InstitutionSchemaToJSONTyped(json, false);
}

export function InstitutionSchemaToJSONTyped(value?: InstitutionSchema | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
