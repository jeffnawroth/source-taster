...
/**
 * Check if a given object implements the NgramMeta interface.
 */
...
export function NgramMetaFromJSON(json: any): NgramMeta {
    return NgramMetaFromJSONTyped(json, false);
}

export function NgramMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): NgramMeta {
    if (json == null) {
        return json;
    }
    return {
