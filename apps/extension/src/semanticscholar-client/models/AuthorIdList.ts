 ...
 * 
 * @export
 * @interface AuthorIdList
 */
export interface AuthorIdList {
    /**
     * 
     * @type {Array<string>}
     * @memberof AuthorIdList
     */
    ids?: Array<string>;
}

/**
 * Check if a given object implements the AuthorIdList interface.
 */
export function instanceOfAuthorIdList(value: object): value is AuthorIdList {
    return true;
}

export function AuthorIdListFromJSON(json: any): AuthorIdList {
    return AuthorIdListFromJSONTyped(json, false);
}

export function AuthorIdListFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorIdList {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthorIdListToJSON(json: any): AuthorIdList {
    return AuthorIdListToJSONTyped(json, false);
}

export function AuthorIdListToJSONTyped(value?: AuthorIdList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
