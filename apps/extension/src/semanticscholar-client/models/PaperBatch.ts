...
/**
 * Check if a given object implements the PaperBatch interface.
 */
export function instanceOfPaperBatch(value: object): value is PaperBatch {
    return true;
}

export function PaperBatchFromJSON(json: any): PaperBatch {
    return PaperBatchFromJSONTyped(json, false);
}

export function PaperBatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaperBatch {
    if (json == null) {
        return json;
    }
    return {
...
export function PaperBatchToJSON(json: any): PaperBatch {
    return PaperBatchToJSONTyped(json, false);
}

export function PaperBatchToJSONTyped(value?: PaperBatch | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
