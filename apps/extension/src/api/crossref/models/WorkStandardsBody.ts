...
/**
 * Check if a given object implements the WorkStandardsBody interface.
 */
export function instanceOfWorkStandardsBody(value: object): value is WorkStandardsBody {
    return true;
}
...
export function WorkStandardsBodyToJSON(json: any): WorkStandardsBody {
    return WorkStandardsBodyToJSONTyped(json, false);
}

export function WorkStandardsBodyToJSONTyped(value?: WorkStandardsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
