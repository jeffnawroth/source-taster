 ...
 * 
 * @export
 * @interface JournalsMessage
 */
export interface JournalsMessage {
    /**
     * 
     * @type {string}
     * @memberof JournalsMessage
     */
    status: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalsMessage interface.
 */
export function instanceOfJournalsMessage(value: object): value is JournalsMessage {
...
export function JournalsMessageFromJSON(json: any): JournalsMessage {
    return JournalsMessageFromJSONTyped(json, false);
}

export function JournalsMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalsMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': JournalsFromJSON(json['message']),
    };
}

export function JournalsMessageToJSON(json: any): JournalsMessage {
    return JournalsMessageToJSONTyped(json, false);
}

export function JournalsMessageToJSONTyped(value?: JournalsMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': JournalsToJSON(value['message']),
    };
}
