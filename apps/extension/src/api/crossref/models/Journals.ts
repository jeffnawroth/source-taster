...
/**
 * Check if a given object implements the Journals interface.
 */
export function instanceOfJournals(value: object): value is Journals {
...
export function JournalsFromJSON(json: any): Journals {
    return JournalsFromJSONTyped(json, false);
}

export function JournalsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Journals {
    if (json == null) {
        return json;
    }
    return {
        ...
        'items': ((json['items'] as Array<any>).map(JournalFromJSON)),
    };
}

export function JournalsToJSON(json: any): Journals {
    return JournalsToJSONTyped(json, false);
}

export function JournalsToJSONTyped(value?: Journals | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(JournalToJSON)),
    };
}
