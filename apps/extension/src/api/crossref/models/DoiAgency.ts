...
/**
 * Check if a given object implements the DoiAgency interface.
 */
export function instanceOfDoiAgency(value: object): value is DoiAgency {
...
export function DoiAgencyToJSON(json: any): DoiAgency {
    return DoiAgencyToJSONTyped(json, false);
}

export function DoiAgencyToJSONTyped(value?: DoiAgency | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
