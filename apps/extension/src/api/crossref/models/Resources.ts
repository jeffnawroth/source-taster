...
import type { PrimaryResource } from './PrimaryResource';
import {
    PrimaryResourceFromJSON,
    PrimaryResourceFromJSONTyped,
    PrimaryResourceToJSON,
    PrimaryResourceToJSONTyped,
} from './PrimaryResource';
import type { SecondaryResource } from './SecondaryResource';
import {
    SecondaryResourceFromJSON,
    SecondaryResourceFromJSONTyped,
    SecondaryResourceToJSON,
    SecondaryResourceToJSONTyped,
} from './SecondaryResource';
...
export interface Resources {
    ...
    /**
     * 
     * @type {Array<SecondaryResource>}
     * @memberof Resources
     */
    secondary?: Array<SecondaryResource>;
}
...
export function ResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): Resources {
    ...
    return {
        ...
        'primary': PrimaryResourceFromJSON(json['primary']),
        'secondary': json['secondary'] == null ? undefined : ((json['secondary'] as Array<any>).map(SecondaryResourceFromJSON)),
    };
}
...
export function ResourcesToJSONTyped(value?: Resources | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'primary': PrimaryResourceToJSON(value['primary']),
        'secondary': value['secondary'] == null ? undefined : ((value['secondary'] as Array<any>).map(SecondaryResourceToJSON)),
    };
}
