...
import type { AffiliationIdentifier } from './AffiliationIdentifier';
import {
    AffiliationIdentifierFromJSON,
    AffiliationIdentifierFromJSONTyped,
    AffiliationIdentifierToJSON,
    AffiliationIdentifierToJSONTyped,
} from './AffiliationIdentifier';

/**
 * 
 * @export
 * @interface InvestigatorAffiliation
 */
export interface InvestigatorAffiliation {
    /**
     * 
     * @type {Array<AffiliationIdentifier>}
     * @memberof InvestigatorAffiliation
     */
    id: Array<AffiliationIdentifier>;
    /**
     * 
     * @type {string}
     * @memberof InvestigatorAffiliation
...
/**
 * Check if a given object implements the InvestigatorAffiliation interface.
 */
export function instanceOfInvestigatorAffiliation(value: object): value is InvestigatorAffiliation {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function InvestigatorAffiliationFromJSON(json: any): InvestigatorAffiliation {
    return InvestigatorAffiliationFromJSONTyped(json, false);
}

export function InvestigatorAffiliationFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvestigatorAffiliation {
    if (json == null) {
        return json;
    }
    return {
        
        'id': ((json['id'] as Array<any>).map(AffiliationIdentifierFromJSON)),
        'name': json['name'],
    };
}

export function InvestigatorAffiliationToJSON(json: any): InvestigatorAffiliation {
    return InvestigatorAffiliationToJSONTyped(json, false);
}

export function InvestigatorAffiliationToJSONTyped(value?: InvestigatorAffiliation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': ((value['id'] as Array<any>).map(AffiliationIdentifierToJSON)),
        'name': value['name'],
    };
}
