...
/**
 * Check if a given object implements the Funders interface.
 */
export function instanceOfFunders(value: object): value is Funders {
...
export function FundersFromJSON(json: any): Funders {
    return FundersFromJSONTyped(json, false);
}

export function FundersFromJSONTyped(json: any, ignoreDiscriminator: boolean): Funders {
    if (json == null) {
        return json;
    }
    return {
        ...
        'items': ((json['items'] as Array<any>).map(FunderFromJSON)),
    };
}

export function FundersToJSON(json: any): Funders {
    return FundersToJSONTyped(json, false);
}

export function FundersToJSONTyped(value?: Funders | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(FunderToJSON)),
    };
}
