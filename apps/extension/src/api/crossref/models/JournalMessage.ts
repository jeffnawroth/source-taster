...
/**
 * Check if a given object implements the JournalMessage interface.
 */
export function instanceOfJournalMessage(value: object): value is JournalMessage {
...
export function JournalMessageFromJSON(json: any): JournalMessage {
    return JournalMessageFromJSONTyped(json, false);
}

export function JournalMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': JournalFromJSON(json['message']),
    };
}

export function JournalMessageToJSON(json: any): JournalMessage {
    return JournalMessageToJSONTyped(json, false);
}

export function JournalMessageToJSONTyped(value?: JournalMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': JournalToJSON(value['message']),
    };
}
