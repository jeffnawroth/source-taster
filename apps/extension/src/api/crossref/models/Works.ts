...
/**
 * Check if a given object implements the Works interface.
 */
export function instanceOfWorks(value: object): value is Works {
...
export function WorksFromJSONTyped(json: any, ignoreDiscriminator: boolean): Works {
    ...
    return {
        ...
        'nextCursor': json['next-cursor'] == null ? undefined : json['next-cursor'],
        'items': ((json['items'] as Array<any>).map(WorkFromJSON)),
    };
}

export function WorksToJSON(json: any): Works {
    return WorksToJSONTyped(json, false);
}

export function WorksToJSONTyped(value?: Works | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
