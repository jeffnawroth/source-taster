...
import {
    InvestigatorAffiliationFromJSON,
    InvestigatorAffiliationFromJSONTyped,
    InvestigatorAffiliationToJSON,
    InvestigatorAffiliationToJSONTyped,
} from './InvestigatorAffiliation';
...
export interface Investigator {
    ...
    /**
     * 
     * @type {Array<InvestigatorAffiliation>}
     * @memberof Investigator
     */
...
/**
 * Check if a given object implements the Investigator interface.
 */
export function instanceOfInvestigator(value: object): value is Investigator {
    if (!('affiliation' in value) || value['affiliation'] === undefined) return false;
    return true;
}

export function InvestigatorFromJSON(json: any): Investigator {
    return InvestigatorFromJSONTyped(json, false);
}

export function InvestigatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Investigator {
    if (json == null) {
        return json;
    }
    return {
        ...
        'affiliation': ((json['affiliation'] as Array<any>).map(InvestigatorAffiliationFromJSON)),
        'name': json['name'] == null ? undefined : json['name'],
        'roleStart': json['role-start'] == null ? undefined : DatePartsFromJSON(json['role-start']),
        'authenticatedOrcid': json['authenticated-orcid'] == null ? undefined : json['authenticated-orcid'],
        'prefix': json['prefix'] == null ? undefined : json['prefix'],
        'alternateName': json['alternate-name'] == null ? undefined : json['alternate-name'],
        'sequence': json['sequence'] == null ? undefined : json['sequence'],
        'roleEnd': json['role-end'] == null ? undefined : DatePartsFromJSON(json['role-end']),
    };
}

export function InvestigatorToJSON(json: any): Investigator {
    return InvestigatorToJSONTyped(json, false);
}

export function InvestigatorToJSONTyped(value?: Investigator | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'given': value['given'],
        'family': value['family'],
        'affiliation': ((value['affiliation'] as Array<any>).map(InvestigatorAffiliationToJSON)),
        'name': value['name'],
        'role-start': DatePartsToJSON(value['roleStart']),
        'authenticated-orcid': value['authenticatedOrcid'],
        'prefix': value['prefix'],
        'alternate-name': value['alternateName'],
        'sequence': value['sequence'],
        'role-end': DatePartsToJSON(value['roleEnd']),
    };
}
