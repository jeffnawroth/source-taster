...
import type { FunderIdentifier } from './FunderIdentifier';
import {
    FunderIdentifierFromJSON,
    FunderIdentifierFromJSONTyped,
    FunderIdentifierToJSON,
    FunderIdentifierToJSONTyped,
} from './FunderIdentifier';
...
export interface WorkFunder {
    ...
    /**
     * 
     * @type {Array<FunderIdentifier>}
     * @memberof WorkFunder
     */
    id?: Array<FunderIdentifier>;
}

/**
 * Check if a given object implements the WorkFunder interface.
 */
export function instanceOfWorkFunder(value: object): value is WorkFunder {
    return true;
}
...
export function WorkFunderFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkFunder {
    ...
    return {
        ...
        'doiAssertedBy': json['doi-asserted-by'] == null ? undefined : json['doi-asserted-by'],
        'award': json['award'] == null ? undefined : json['award'],
        'id': json['id'] == null ? undefined : ((json['id'] as Array<any>).map(FunderIdentifierFromJSON)),
    };
}

export function WorkFunderToJSON(json: any): WorkFunder {
    return WorkFunderToJSONTyped(json, false);
}

export function WorkFunderToJSONTyped(value?: WorkFunder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'award': value['award'],
        'id': value['id'] == null ? undefined : ((value['id'] as Array<any>).map(FunderIdentifierToJSON)),
    };
}
