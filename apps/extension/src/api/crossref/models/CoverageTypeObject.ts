...
/**
 * Check if a given object implements the CoverageTypeObject interface.
 */
export function instanceOfCoverageTypeObject(value: object): value is CoverageTypeObject {
    if (!('all' in value) || value['all'] === undefined) return false;
    if (!('current' in value) || value['current'] === undefined) return false;
    if (!('backfile' in value) || value['backfile'] === undefined) return false;
    return true;
}

export function CoverageTypeObjectFromJSON(json: any): CoverageTypeObject {
    return CoverageTypeObjectFromJSONTyped(json, false);
}

export function CoverageTypeObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoverageTypeObject {
    if (json == null) {
        return json;
    }
    return {
        
        'all': (mapValues(json['all'], CoverageFromJSON)),
        'current': (mapValues(json['current'], CoverageFromJSON)),
        'backfile': (mapValues(json['backfile'], CoverageFromJSON)),
    };
}

export function CoverageTypeObjectToJSON(json: any): CoverageTypeObject {
    return CoverageTypeObjectToJSONTyped(json, false);
}

export function CoverageTypeObjectToJSONTyped(value?: CoverageTypeObject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'all': (mapValues(value['all'], CoverageToJSON)),
        'current': (mapValues(value['current'], CoverageToJSON)),
        'backfile': (mapValues(value['backfile'], CoverageToJSON)),
    };
}
