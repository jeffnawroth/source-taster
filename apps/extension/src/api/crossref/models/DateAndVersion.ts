 ...
 * 
 * @export
 * @interface DateAndVersion
 */
export interface DateAndVersion {
    /**
     * 
     * @type {Array<Array<number>>}
     * @memberof DateAndVersion
     */
...
/**
 * Check if a given object implements the DateAndVersion interface.
 */
export function instanceOfDateAndVersion(value: object): value is DateAndVersion {
    if (!('dateParts' in value) || value['dateParts'] === undefined) return false;
...
export function DateAndVersionFromJSON(json: any): DateAndVersion {
    return DateAndVersionFromJSONTyped(json, false);
}

export function DateAndVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): DateAndVersion {
    if (json == null) {
        return json;
    }
    return {
...
export function DateAndVersionToJSON(json: any): DateAndVersion {
    return DateAndVersionToJSONTyped(json, false);
}

export function DateAndVersionToJSONTyped(value?: DateAndVersion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
