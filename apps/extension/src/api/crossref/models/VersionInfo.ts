...
import type { VersionInfoDescription } from './VersionInfoDescription';
import {
    VersionInfoDescriptionFromJSON,
    VersionInfoDescriptionFromJSONTyped,
    VersionInfoDescriptionToJSON,
    VersionInfoDescriptionToJSONTyped,
} from './VersionInfoDescription';
...
export interface VersionInfo {
    ...
    /**
     * 
     * @type {Array<VersionInfoDescription>}
     * @memberof VersionInfo
     */
    versionDescription?: Array<VersionInfoDescription>;
}
...
export function VersionInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionInfo {
    ...
    return {
        ...
        'versionDescription': json['version-description'] == null ? undefined : ((json['version-description'] as Array<any>).map(VersionInfoDescriptionFromJSON)),
    };
}
...
export function VersionInfoToJSONTyped(value?: VersionInfo | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'version-description': value['versionDescription'] == null ? undefined : ((value['versionDescription'] as Array<any>).map(VersionInfoDescriptionToJSON)),
    };
}
