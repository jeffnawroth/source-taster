...
/**
 * Check if a given object implements the WorkDomain interface.
 */
export function instanceOfWorkDomain(value: object): value is WorkDomain {
...
export function WorkDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkDomain {
    ...
    return {
        ...
        'domain': json['domain'],
        'crossmarkRestriction': json['crossmark-restriction'] == null ? undefined : json['crossmark-restriction'],
    };
}

export function WorkDomainToJSON(json: any): WorkDomain {
    return WorkDomainToJSONTyped(json, false);
}

export function WorkDomainToJSONTyped(value?: WorkDomain | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
