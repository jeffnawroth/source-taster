...
import {
    FunderHierarchyFromJSON,
    FunderHierarchyFromJSONTyped,
    FunderHierarchyToJSON,
    FunderHierarchyToJSONTyped,
} from './FunderHierarchy';

/**
 * 
 * @export
 * @interface FunderFull
 */
...
/**
 * Check if a given object implements the FunderFull interface.
 */
export function instanceOfFunderFull(value: object): value is FunderFull {
    if (!('hierarchyNames' in value) || value['hierarchyNames'] === undefined) return false;
    if (!('replacedBy' in value) || value['replacedBy'] === undefined) return false;
    if (!('workCount' in value) || value['workCount'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('descendants' in value) || value['descendants'] === undefined) return false;
    if (!('descendantWorkCount' in value) || value['descendantWorkCount'] === undefined) return false;
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('tokens' in value) || value['tokens'] === undefined) return false;
    if (!('replaces' in value) || value['replaces'] === undefined) return false;
...
export function FunderFullFromJSON(json: any): FunderFull {
    return FunderFullFromJSONTyped(json, false);
}

export function FunderFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): FunderFull {
    if (json == null) {
        return json;
    }
    return {
        
        'hierarchyNames': json['hierarchy-names'],
        'replacedBy': json['replaced-by'],
        'workCount': json['work-count'],
        'name': json['name'],
        'descendants': json['descendants'],
        'descendantWorkCount': json['descendant-work-count'],
        'id': json['id'],
        'tokens': json['tokens'],
        'replaces': json['replaces'],
        'uri': json['uri'],
        'hierarchy': FunderHierarchyFromJSON(json['hierarchy']),
        'altNames': json['alt-names'],
        'location': json['location'],
    };
}

export function FunderFullToJSON(json: any): FunderFull {
    return FunderFullToJSONTyped(json, false);
}

export function FunderFullToJSONTyped(value?: FunderFull | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'hierarchy-names': value['hierarchyNames'],
        'replaced-by': value['replacedBy'],
        'work-count': value['workCount'],
        'name': value['name'],
        'descendants': value['descendants'],
        'descendant-work-count': value['descendantWorkCount'],
        'id': value['id'],
        'tokens': value['tokens'],
        'replaces': value['replaces'],
        'uri': value['uri'],
        'hierarchy': FunderHierarchyToJSON(value['hierarchy']),
        'alt-names': value['altNames'],
