...
import {
    AwardAmountFromJSON,
    AwardAmountFromJSONTyped,
    AwardAmountToJSON,
    AwardAmountToJSONTyped,
} from './AwardAmount';
...
import {
    ProjectTitleFromJSON,
    ProjectTitleFromJSONTyped,
    ProjectTitleToJSON,
    ProjectTitleToJSONTyped,
} from './ProjectTitle';
...
import {
    InvestigatorFromJSON,
    InvestigatorFromJSONTyped,
    InvestigatorToJSON,
    InvestigatorToJSONTyped,
} from './Investigator';
...
export interface WorkProject {
    /**
     * 
     * @type {Array<DateParts>}
     * @memberof WorkProject
     */
    awardEnd?: Array<DateParts>;
    /**
     * 
     * @type {Array<DateParts>}
     * @memberof WorkProject
     */
    awardPlannedStart?: Array<DateParts>;
    /**
     * 
     * @type {Array<DateParts>}
     * @memberof WorkProject
     */
    awardStart?: Array<DateParts>;
    /**
     * 
     * @type {Array<Investigator>}
     * @memberof WorkProject
     */
    leadInvestigator?: Array<Investigator>;
    /**
     * 
     * @type {Array<DateParts>}
     * @memberof WorkProject
     */
    awardPlannedEnd?: Array<DateParts>;
    /**
     * 
     * @type {Array<Investigator>}
     * @memberof WorkProject
    ...
    /**
     * 
     * @type {Array<ProjectTitle>}
     * @memberof WorkProject
     */
    projectTitle: Array<ProjectTitle>;
    /**
     * 
     * @type {AwardAmount}
     * @memberof WorkProject
     ...
     * @memberof WorkProject
     */
    coLeadInvestigator?: Array<Investigator>;
}

/**
 * Check if a given object implements the WorkProject interface.
 */
export function instanceOfWorkProject(value: object): value is WorkProject {
    if (!('projectTitle' in value) || value['projectTitle'] === undefined) return false;
    return true;
}

export function WorkProjectFromJSON(json: any): WorkProject {
    return WorkProjectFromJSONTyped(json, false);
}

export function WorkProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkProject {
    if (json == null) {
        return json;
    }
    return {
        
        'awardEnd': json['award-end'] == null ? undefined : ((json['award-end'] as Array<any>).map(DatePartsFromJSON)),
        'awardPlannedStart': json['award-planned-start'] == null ? undefined : ((json['award-planned-start'] as Array<any>).map(DatePartsFromJSON)),
        'awardStart': json['award-start'] == null ? undefined : ((json['award-start'] as Array<any>).map(DatePartsFromJSON)),
        'leadInvestigator': json['lead-investigator'] == null ? undefined : ((json['lead-investigator'] as Array<any>).map(InvestigatorFromJSON)),
        'awardPlannedEnd': json['award-planned-end'] == null ? undefined : ((json['award-planned-end'] as Array<any>).map(DatePartsFromJSON)),
        'investigator': json['investigator'] == null ? undefined : ((json['investigator'] as Array<any>).map(InvestigatorFromJSON)),
        'funding': json['funding'] == null ? undefined : ((json['funding'] as Array<any>).map(FundingFromJSON)),
        'projectTitle': ((json['project-title'] as Array<any>).map(ProjectTitleFromJSON)),
        'awardAmount': json['award-amount'] == null ? undefined : AwardAmountFromJSON(json['award-amount']),
        'coLeadInvestigator': json['co-lead-investigator'] == null ? undefined : ((json['co-lead-investigator'] as Array<any>).map(InvestigatorFromJSON)),
    };
}

export function WorkProjectToJSON(json: any): WorkProject {
    return WorkProjectToJSONTyped(json, false);
}

export function WorkProjectToJSONTyped(value?: WorkProject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'award-end': value['awardEnd'] == null ? undefined : ((value['awardEnd'] as Array<any>).map(DatePartsToJSON)),
        'award-planned-start': value['awardPlannedStart'] == null ? undefined : ((value['awardPlannedStart'] as Array<any>).map(DatePartsToJSON)),
        'award-start': value['awardStart'] == null ? undefined : ((value['awardStart'] as Array<any>).map(DatePartsToJSON)),
        'lead-investigator': value['leadInvestigator'] == null ? undefined : ((value['leadInvestigator'] as Array<any>).map(InvestigatorToJSON)),
        'award-planned-end': value['awardPlannedEnd'] == null ? undefined : ((value['awardPlannedEnd'] as Array<any>).map(DatePartsToJSON)),
        'investigator': value['investigator'] == null ? undefined : ((value['investigator'] as Array<any>).map(InvestigatorToJSON)),
        'funding': value['funding'] == null ? undefined : ((value['funding'] as Array<any>).map(FundingToJSON)),
        'project-title': ((value['projectTitle'] as Array<any>).map(ProjectTitleToJSON)),
        'award-amount': AwardAmountToJSON(value['awardAmount']),
        'co-lead-investigator': value['coLeadInvestigator'] == null ? undefined : ((value['coLeadInvestigator'] as Array<any>).map(InvestigatorToJSON)),
    };
}
