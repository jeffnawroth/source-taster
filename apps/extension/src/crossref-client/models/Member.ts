...
import {
    CoverageTypeObjectFromJSON,
    CoverageTypeObjectFromJSONTyped,
    CoverageTypeObjectToJSON,
    CoverageTypeObjectToJSONTyped,
} from './CoverageTypeObject';
import type { BreakdownsObject } from './BreakdownsObject';
import {
    BreakdownsObjectFromJSON,
    BreakdownsObjectFromJSONTyped,
    BreakdownsObjectToJSON,
    BreakdownsObjectToJSONTyped,
} from './BreakdownsObject';
import type { DoiCounts } from './DoiCounts';
import {
    DoiCountsFromJSON,
    DoiCountsFromJSONTyped,
    DoiCountsToJSON,
    DoiCountsToJSONTyped,
} from './DoiCounts';
import type { MemberCountsType } from './MemberCountsType';
import {
    MemberCountsTypeFromJSON,
    MemberCountsTypeFromJSONTyped,
    MemberCountsTypeToJSON,
    MemberCountsTypeToJSONTyped,
} from './MemberCountsType';
...
import {
    MemberPrefixFromJSON,
    MemberPrefixFromJSONTyped,
    MemberPrefixToJSON,
    MemberPrefixToJSONTyped,
} from './MemberPrefix';
import type { CoverageFull } from './CoverageFull';
import {
    CoverageFullFromJSON,
    CoverageFullFromJSONTyped,
    CoverageFullToJSON,
    CoverageFullToJSONTyped,
} from './CoverageFull';
...
export interface Member {
    ...
    /**
     * 
     * @type {MemberCountsType}
     * @memberof Member
     */
    countsType: MemberCountsType;
    /**
     * 
     * @type {CoverageTypeObject}
     * @memberof Member
     */
    coverageType: CoverageTypeObject;
    /**
     * 
     * @type {Flags}
     * @memberof Member
...
export function instanceOfMember(value: object): value is Member {
    ...
    if (!('countsType' in value) || value['countsType'] === undefined) return false;
    if (!('coverageType' in value) || value['coverageType'] === undefined) return false;
...
export function MemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): Member {
    ...
    return {
        ...
        'primaryName': json['primary-name'],
        'counts': DoiCountsFromJSON(json['counts']),
        'breakdowns': BreakdownsObjectFromJSON(json['breakdowns']),
        'prefixes': json['prefixes'],
        'coverage': CoverageFullFromJSON(json['coverage']),
        'prefix': ((json['prefix'] as Array<any>).map(MemberPrefixFromJSON)),
        'id': json['id'],
        'tokens': json['tokens'],
        'countsType': MemberCountsTypeFromJSON(json['counts-type']),
        'coverageType': CoverageTypeObjectFromJSON(json['coverage-type']),
...
export function MemberToJSONTyped(value?: Member | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'primary-name': value['primaryName'],
        'counts': DoiCountsToJSON(value['counts']),
        'breakdowns': BreakdownsObjectToJSON(value['breakdowns']),
        'prefixes': value['prefixes'],
        'coverage': CoverageFullToJSON(value['coverage']),
        'prefix': ((value['prefix'] as Array<any>).map(MemberPrefixToJSON)),
        'id': value['id'],
        'tokens': value['tokens'],
        'counts-type': MemberCountsTypeToJSON(value['countsType']),
        'coverage-type': CoverageTypeObjectToJSON(value['coverageType']),
