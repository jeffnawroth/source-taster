...
import {
    JournalIssnTypeFromJSON,
    JournalIssnTypeFromJSONTyped,
    JournalIssnTypeToJSON,
    JournalIssnTypeToJSONTyped,
} from './JournalIssnType';
...
export function instanceOfJournal(value: object): value is Journal {
    ...
    if (!('issnType' in value) || value['issnType'] === undefined) return false;
    return true;
}
...
export function JournalFromJSONTyped(json: any, ignoreDiscriminator: boolean): Journal {
    ...
    return {
        ...
        'iSSN': json['ISSN'],
        'issnType': JournalIssnTypeFromJSON(json['issn-type']),
    };
}

export function JournalToJSON(json: any): Journal {
    return JournalToJSONTyped(json, false);
}

export function JournalToJSONTyped(value?: Journal | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'ISSN': value['iSSN'],
        'issn-type': JournalIssnTypeToJSON(value['issnType']),
    };
}
