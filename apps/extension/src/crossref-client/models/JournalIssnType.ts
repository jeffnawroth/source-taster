 ...
 * 
 * @export
 * @interface JournalIssnType
 */
export interface JournalIssnType {
    /**
     * 
     * @type {string}
     * @memberof JournalIssnType
     */
    value: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalIssnType interface.
 */
export function instanceOfJournalIssnType(value: object): value is JournalIssnType {
    if (!('value' in value) || value['value'] === undefined) return false;
    if (!('type' in value) || value['type'] === undefined) return false;
    return true;
}

export function JournalIssnTypeFromJSON(json: any): JournalIssnType {
    return JournalIssnTypeFromJSONTyped(json, false);
}

export function JournalIssnTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalIssnType {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalIssnTypeToJSON(json: any): JournalIssnType {
    return JournalIssnTypeToJSONTyped(json, false);
}

export function JournalIssnTypeToJSONTyped(value?: JournalIssnType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
