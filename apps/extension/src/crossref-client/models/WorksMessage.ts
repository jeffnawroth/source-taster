...
/**
 * Check if a given object implements the WorksMessage interface.
 */
export function instanceOfWorksMessage(value: object): value is WorksMessage {
...
export function WorksMessageToJSON(json: any): WorksMessage {
    return WorksMessageToJSONTyped(json, false);
}

export function WorksMessageToJSONTyped(value?: WorksMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
