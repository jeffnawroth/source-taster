...
/**
 * Check if a given object implements the AgencyMessage interface.
 */
export function instanceOfAgencyMessage(value: object): value is AgencyMessage {
...
export function AgencyMessageToJSON(json: any): AgencyMessage {
    return AgencyMessageToJSONTyped(json, false);
}

export function AgencyMessageToJSONTyped(value?: AgencyMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
