 ...
 * 
 * @export
 * @interface FunderIdentifier
 */
export interface FunderIdentifier {
    /**
     * 
     * @type {string}
     * @memberof FunderIdentifier
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the FunderIdentifier interface.
 */
export function instanceOfFunderIdentifier(value: object): value is FunderIdentifier {
...
export function FunderIdentifierFromJSON(json: any): FunderIdentifier {
    return FunderIdentifierFromJSONTyped(json, false);
}

export function FunderIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): FunderIdentifier {
    if (json == null) {
        return json;
    }
    return {
...
export function FunderIdentifierToJSON(json: any): FunderIdentifier {
    return FunderIdentifierToJSONTyped(json, false);
}

export function FunderIdentifierToJSONTyped(value?: FunderIdentifier | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
