 ...
 * 
 * @export
 * @interface AffiliationIdentifier
 */
export interface AffiliationIdentifier {
    /**
     * 
     * @type {string}
     * @memberof AffiliationIdentifier
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the AffiliationIdentifier interface.
 */
export function instanceOfAffiliationIdentifier(value: object): value is AffiliationIdentifier {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('idType' in value) || value['idType'] === undefined) return false;
    if (!('assertedBy' in value) || value['assertedBy'] === undefined) return false;
    return true;
}

export function AffiliationIdentifierFromJSON(json: any): AffiliationIdentifier {
    return AffiliationIdentifierFromJSONTyped(json, false);
}

export function AffiliationIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): AffiliationIdentifier {
    if (json == null) {
        return json;
    }
    return {
...
export function AffiliationIdentifierToJSON(json: any): AffiliationIdentifier {
    return AffiliationIdentifierToJSONTyped(json, false);
}

export function AffiliationIdentifierToJSONTyped(value?: AffiliationIdentifier | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
