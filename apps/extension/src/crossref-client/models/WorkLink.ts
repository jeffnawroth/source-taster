...
/**
 * Check if a given object implements the WorkLink interface.
 */
export function instanceOfWorkLink(value: object): value is WorkLink {
    if (!('uRL' in value) || value['uRL'] === undefined) return false;
    if (!('contentType' in value) || value['contentType'] === undefined) return false;
    if (!('contentVersion' in value) || value['contentVersion'] === undefined) return false;
    if (!('intendedApplication' in value) || value['intendedApplication'] === undefined) return false;
    return true;
}
...
export function WorkLinkToJSON(json: any): WorkLink {
    return WorkLinkToJSONTyped(json, false);
}

export function WorkLinkToJSONTyped(value?: WorkLink | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
