...
/**
 * Check if a given object implements the TypesMessage interface.
 */
export function instanceOfTypesMessage(value: object): value is TypesMessage {
...
export function TypesMessageFromJSON(json: any): TypesMessage {
    return TypesMessageFromJSONTyped(json, false);
}

export function TypesMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): TypesMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': TypesFromJSON(json['message']),
    };
}

export function TypesMessageToJSON(json: any): TypesMessage {
    return TypesMessageToJSONTyped(json, false);
}

export function TypesMessageToJSONTyped(value?: TypesMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': TypesToJSON(value['message']),
    };
}
