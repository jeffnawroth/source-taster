...
/**
 * Check if a given object implements the WorkMessage interface.
 */
export function instanceOfWorkMessage(value: object): value is WorkMessage {
...
export function WorkMessageToJSON(json: any): WorkMessage {
    return WorkMessageToJSONTyped(json, false);
}

export function WorkMessageToJSONTyped(value?: WorkMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
