...
import {
    WorkAssertionExplanationFromJSON,
    WorkAssertionExplanationFromJSONTyped,
    WorkAssertionExplanationToJSON,
    WorkAssertionExplanationToJSONTyped,
} from './WorkAssertionExplanation';
import type { WorkAssertionGroup } from './WorkAssertionGroup';
import {
    WorkAssertionGroupFromJSON,
    WorkAssertionGroupFromJSONTyped,
    WorkAssertionGroupToJSON,
    WorkAssertionGroupToJSONTyped,
} from './WorkAssertionGroup';
...
export interface WorkAssertion {
    /**
     * 
     * @type {WorkAssertionGroup}
     * @memberof WorkAssertion
     */
    group?: WorkAssertionGroup;
    /**
     * 
     * @type {WorkAssertionExplanation}
     * @memberof WorkAssertion
     */
...
/**
 * Check if a given object implements the WorkAssertion interface.
 */
export function instanceOfWorkAssertion(value: object): value is WorkAssertion {
...
export function WorkAssertionFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkAssertion {
    ...
    return {
        ...
        'group': json['group'] == null ? undefined : WorkAssertionGroupFromJSON(json['group']),
        'explanation': json['explanation'] == null ? undefined : WorkAssertionExplanationFromJSON(json['explanation']),
        'name': json['name'],
...
export function WorkAssertionToJSON(json: any): WorkAssertion {
    return WorkAssertionToJSONTyped(json, false);
}

export function WorkAssertionToJSONTyped(value?: WorkAssertion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'group': WorkAssertionGroupToJSON(value['group']),
        'explanation': WorkAssertionExplanationToJSON(value['explanation']),
        'name': value['name'],
        'value': value['value'],
        'URL': value['uRL'],
        'order': value['order'],
