...
/**
 * Check if a given object implements the SecondaryResource interface.
 */
export function instanceOfSecondaryResource(value: object): value is SecondaryResource {
    if (!('uRL' in value) || value['uRL'] === undefined) return false;
    if (!('label' in value) || value['label'] === undefined) return false;
    return true;
}

export function SecondaryResourceFromJSON(json: any): SecondaryResource {
    return SecondaryResourceFromJSONTyped(json, false);
}

export function SecondaryResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): SecondaryResource {
    if (json == null) {
        return json;
    }
    return {
...
export function SecondaryResourceToJSON(json: any): SecondaryResource {
    return SecondaryResourceToJSONTyped(json, false);
}

export function SecondaryResourceToJSONTyped(value?: SecondaryResource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
