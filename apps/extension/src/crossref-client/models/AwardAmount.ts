 ...
 * 
 * @export
 * @interface AwardAmount
 */
export interface AwardAmount {
    /**
     * 
     * @type {number}
     * @memberof AwardAmount
     */
    amount: number;
    /**
     * 
...
/**
 * Check if a given object implements the AwardAmount interface.
 */
export function instanceOfAwardAmount(value: object): value is AwardAmount {
    if (!('amount' in value) || value['amount'] === undefined) return false;
    return true;
}

export function AwardAmountFromJSON(json: any): AwardAmount {
    return AwardAmountFromJSONTyped(json, false);
}

export function AwardAmountFromJSONTyped(json: any, ignoreDiscriminator: boolean): AwardAmount {
    if (json == null) {
        return json;
    }
    return {
...
export function AwardAmountToJSON(json: any): AwardAmount {
    return AwardAmountToJSONTyped(json, false);
}

export function AwardAmountToJSONTyped(value?: AwardAmount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
