 ...
 * 
 * @export
 * @interface MemberCountsType
 */
export interface MemberCountsType {
    /**
     * 
     * @type {{ [key: string]: number; }}
     * @memberof MemberCountsType
     */
     ...
     * @memberof MemberCountsType
     */
    backfile: { [key: string]: number; };
}

/**
 * Check if a given object implements the MemberCountsType interface.
 */
export function instanceOfMemberCountsType(value: object): value is MemberCountsType {
...
export function MemberCountsTypeFromJSON(json: any): MemberCountsType {
    return MemberCountsTypeFromJSONTyped(json, false);
}

export function MemberCountsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberCountsType {
    if (json == null) {
        return json;
    }
    return {
...
export function MemberCountsTypeToJSON(json: any): MemberCountsType {
    return MemberCountsTypeToJSONTyped(json, false);
}

export function MemberCountsTypeToJSONTyped(value?: MemberCountsType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
