...
export function ReferenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): Reference {
    ...
    return {
        ...
        'standardsBody': json['standards-body'] == null ? undefined : json['standards-body'],
        'issue': json['issue'] == null ? undefined : json['issue'],
        'key': json['key'] == null ? undefined : json['key'],
        'seriesTitle': json['series-title'] == null ? undefined : json['series-title'],
        'isbnType': json['isbn-type'] == null ? undefined : json['isbn-type'],
        'doiAssertedBy': json['doi-asserted-by'] == null ? undefined : json['doi-asserted-by'],
        'firstPage': json['first-page'] == null ? undefined : json['first-page'],
        'type': json['type'] == null ? undefined : json['type'],
        'isbn': json['isbn'] == null ? undefined : json['isbn'],
        'doi': json['doi'] == null ? undefined : json['doi'],
        'component': json['component'] == null ? undefined : json['component'],
        'articleTitle': json['article-title'] == null ? undefined : json['article-title'],
        'volumeTitle': json['volume-title'] == null ? undefined : json['volume-title'],
        'volume': json['volume'] == null ? undefined : json['volume'],
        'author': json['author'] == null ? undefined : json['author'],
        'standardDesignator': json['standard-designator'] == null ? undefined : json['standard-designator'],
        'year': json['year'] == null ? undefined : json['year'],
        'unstructured': json['unstructured'] == null ? undefined : json['unstructured'],
        'edition': json['edition'] == null ? undefined : json['edition'],
        'journalTitle': json['journal-title'] == null ? undefined : json['journal-title'],
        'issnType': json['issn-type'] == null ? undefined : json['issn-type'],
    };
}
