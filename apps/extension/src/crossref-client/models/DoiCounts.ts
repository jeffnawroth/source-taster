...
/**
 * Check if a given object implements the DoiCounts interface.
 */
export function instanceOfDoiCounts(value: object): value is DoiCounts {
    if (!('totalDois' in value) || value['totalDois'] === undefined) return false;
    if (!('currentDois' in value) || value['currentDois'] === undefined) return false;
    if (!('backfileDois' in value) || value['backfileDois'] === undefined) return false;
    return true;
}

export function DoiCountsFromJSON(json: any): DoiCounts {
    return DoiCountsFromJSONTyped(json, false);
}

export function DoiCountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DoiCounts {
    if (json == null) {
        return json;
    }
    return {
...
export function DoiCountsToJSON(json: any): DoiCounts {
    return DoiCountsToJSONTyped(json, false);
}

export function DoiCountsToJSONTyped(value?: DoiCounts | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'total-dois': value['totalDois'],
        'current-dois': value['currentDois'],
        'backfile-dois': value['backfileDois'],
    };
}
