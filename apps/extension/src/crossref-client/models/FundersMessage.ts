 ...
 * 
 * @export
 * @interface FundersMessage
 */
export interface FundersMessage {
    /**
     * 
     * @type {string}
     * @memberof FundersMessage
     */
    status: string;
    /**
     * 
...
/**
 * Check if a given object implements the FundersMessage interface.
 */
export function instanceOfFundersMessage(value: object): value is FundersMessage {
...
export function FundersMessageFromJSON(json: any): FundersMessage {
    return FundersMessageFromJSONTyped(json, false);
}

export function FundersMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): FundersMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': FundersFromJSON(json['message']),
    };
}

export function FundersMessageToJSON(json: any): FundersMessage {
    return FundersMessageToJSONTyped(json, false);
}

export function FundersMessageToJSONTyped(value?: FundersMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': FundersToJSON(value['message']),
    };
}
