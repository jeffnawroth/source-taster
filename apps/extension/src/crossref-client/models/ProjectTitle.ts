...
/**
 * Check if a given object implements the ProjectTitle interface.
 */
export function instanceOfProjectTitle(value: object): value is ProjectTitle {
    if (!('title' in value) || value['title'] === undefined) return false;
    return true;
}

export function ProjectTitleFromJSON(json: any): ProjectTitle {
    return ProjectTitleFromJSONTyped(json, false);
}

export function ProjectTitleFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectTitle {
    if (json == null) {
        return json;
    }
    return {
...
export function ProjectTitleToJSON(json: any): ProjectTitle {
    return ProjectTitleToJSONTyped(json, false);
}

export function ProjectTitleToJSONTyped(value?: ProjectTitle | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
