...
import {
    FunderFullFromJSON,
    FunderFullFromJSONTyped,
    FunderFullToJSON,
    FunderFullToJSONTyped,
} from './FunderFull';
...
/**
 * Check if a given object implements the FunderMessage interface.
 */
export function instanceOfFunderMessage(value: object): value is FunderMessage {
...
export function FunderMessageFromJSON(json: any): FunderMessage {
    return FunderMessageFromJSONTyped(json, false);
}

export function FunderMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): FunderMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': FunderFullFromJSON(json['message']),
    };
}

export function FunderMessageToJSON(json: any): FunderMessage {
    return FunderMessageToJSONTyped(json, false);
}

export function FunderMessageToJSONTyped(value?: FunderMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': FunderFullToJSON(value['message']),
    };
}
