...
import {
    StatusDescriptionFromJSON,
    StatusDescriptionFromJSONTyped,
    StatusDescriptionToJSON,
    StatusDescriptionToJSONTyped,
} from './StatusDescription';

/**
 * 
 * @export
 * @interface PostedContentStatus
 */
export interface PostedContentStatus {
    /**
     * 
     * @type {string}
     * @memberof PostedContentStatus
     */
    type: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<StatusDescription>}
     * @memberof PostedContentStatus
     */
    statusDescription: Array<StatusDescription>;
}

/**
 * Check if a given object implements the PostedContentStatus interface.
 */
export function instanceOfPostedContentStatus(value: object): value is PostedContentStatus {
...
export function PostedContentStatusFromJSON(json: any): PostedContentStatus {
    return PostedContentStatusFromJSONTyped(json, false);
}

export function PostedContentStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostedContentStatus {
    if (json == null) {
        return json;
    }
    return {
        ...
        'type': json['type'],
        'update': DatePartsFromJSON(json['update']),
        'statusDescription': ((json['status-description'] as Array<any>).map(StatusDescriptionFromJSON)),
    };
}

export function PostedContentStatusToJSON(json: any): PostedContentStatus {
    return PostedContentStatusToJSONTyped(json, false);
}

export function PostedContentStatusToJSONTyped(value?: PostedContentStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'type': value['type'],
        'update': DatePartsToJSON(value['update']),
        'status-description': ((value['statusDescription'] as Array<any>).map(StatusDescriptionToJSON)),
    };
}
