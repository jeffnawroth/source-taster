 ...
 * 
 * @export
 * @interface LicensesMessage
 */
export interface LicensesMessage {
    /**
     * 
     * @type {string}
     * @memberof LicensesMessage
     */
    status: string;
    /**
     * 
...
/**
 * Check if a given object implements the LicensesMessage interface.
 */
export function instanceOfLicensesMessage(value: object): value is LicensesMessage {
...
export function LicensesMessageFromJSON(json: any): LicensesMessage {
    return LicensesMessageFromJSONTyped(json, false);
}

export function LicensesMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): LicensesMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': LicensesFromJSON(json['message']),
    };
}

export function LicensesMessageToJSON(json: any): LicensesMessage {
    return LicensesMessageToJSONTyped(json, false);
}

export function LicensesMessageToJSONTyped(value?: LicensesMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': LicensesToJSON(value['message']),
    };
}
