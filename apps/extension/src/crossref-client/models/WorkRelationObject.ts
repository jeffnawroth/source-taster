 ...
 * 
 * @export
 * @interface WorkRelationObject
 */
export interface WorkRelationObject {
    /**
     * 
     * @type {string}
     * @memberof WorkRelationObject
     */
    idType: string;
    /**
     * 
...
/**
 * Check if a given object implements the WorkRelationObject interface.
 */
export function instanceOfWorkRelationObject(value: object): value is WorkRelationObject {
...
export function WorkRelationObjectFromJSON(json: any): WorkRelationObject {
    return WorkRelationObjectFromJSONTyped(json, false);
}

export function WorkRelationObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkRelationObject {
    if (json == null) {
        return json;
    }
    return {
...
export function WorkRelationObjectToJSON(json: any): WorkRelationObject {
    return WorkRelationObjectToJSONTyped(json, false);
}

export function WorkRelationObjectToJSONTyped(value?: WorkRelationObject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
