...
/**
 * Check if a given object implements the WorkClinicalTrial interface.
 */
export function instanceOfWorkClinicalTrial(value: object): value is WorkClinicalTrial {
    if (!('clinicalTrialNumber' in value) || value['clinicalTrialNumber'] === undefined) return false;
...
export function WorkClinicalTrialToJSON(json: any): WorkClinicalTrial {
    return WorkClinicalTrialToJSONTyped(json, false);
}

export function WorkClinicalTrialToJSONTyped(value?: WorkClinicalTrial | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
