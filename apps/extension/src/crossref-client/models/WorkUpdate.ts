...
/**
 * Check if a given object implements the WorkUpdate interface.
 */
export function instanceOfWorkUpdate(value: object): value is WorkUpdate {
...
export function WorkUpdateToJSON(json: any): WorkUpdate {
    return WorkUpdateToJSONTyped(json, false);
}

export function WorkUpdateToJSONTyped(value?: WorkUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
