...
/**
 * Check if a given object implements the MembersMessage interface.
 */
export function instanceOfMembersMessage(value: object): value is MembersMessage {
...
export function MembersMessageFromJSON(json: any): MembersMessage {
    return MembersMessageFromJSONTyped(json, false);
}

export function MembersMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembersMessage {
    if (json == null) {
        return json;
    }
    return {
        ...
        'message': MembersFromJSON(json['message']),
    };
}

export function MembersMessageToJSON(json: any): MembersMessage {
    return MembersMessageToJSONTyped(json, false);
}

export function MembersMessageToJSONTyped(value?: MembersMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'message': MembersToJSON(value['message']),
    };
}
