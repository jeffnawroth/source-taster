...
export function instanceOfFlags(value: object): value is Flags {
    if (!('depositsAbstractsCurrent' in value) || value['depositsAbstractsCurrent'] === undefined) return false;
    if (!('depositsOrcidsCurrent' in value) || value['depositsOrcidsCurrent'] === undefined) return false;
    if (!('deposits' in value) || value['deposits'] === undefined) return false;
    if (!('depositsAffiliationsBackfile' in value) || value['depositsAffiliationsBackfile'] === undefined) return false;
    if (!('depositsUpdatePoliciesBackfile' in value) || value['depositsUpdatePoliciesBackfile'] === undefined) return false;
    if (!('depositsAwardNumbersCurrent' in value) || value['depositsAwardNumbersCurrent'] === undefined) return false;
    if (!('depositsResourceLinksCurrent' in value) || value['depositsResourceLinksCurrent'] === undefined) return false;
    if (!('depositsRorIdsCurrent' in value) || value['depositsRorIdsCurrent'] === undefined) return false;
    if (!('depositsArticles' in value) || value['depositsArticles'] === undefined) return false;
    if (!('depositsAffiliationsCurrent' in value) || value['depositsAffiliationsCurrent'] === undefined) return false;
    if (!('depositsFundersCurrent' in value) || value['depositsFundersCurrent'] === undefined) return false;
    if (!('depositsReferencesBackfile' in value) || value['depositsReferencesBackfile'] === undefined) return false;
    if (!('depositsRorIdsBackfile' in value) || value['depositsRorIdsBackfile'] === undefined) return false;
    if (!('depositsAbstractsBackfile' in value) || value['depositsAbstractsBackfile'] === undefined) return false;
    if (!('depositsLicensesBackfile' in value) || value['depositsLicensesBackfile'] === undefined) return false;
    if (!('depositsAwardNumbersBackfile' in value) || value['depositsAwardNumbersBackfile'] === undefined) return false;
    if (!('depositsDescriptionsCurrent' in value) || value['depositsDescriptionsCurrent'] === undefined) return false;
    if (!('depositsReferencesCurrent' in value) || value['depositsReferencesCurrent'] === undefined) return false;
    if (!('depositsResourceLinksBackfile' in value) || value['depositsResourceLinksBackfile'] === undefined) return false;
    if (!('depositsDescriptionsBackfile' in value) || value['depositsDescriptionsBackfile'] === undefined) return false;
    if (!('depositsOrcidsBackfile' in value) || value['depositsOrcidsBackfile'] === undefined) return false;
    if (!('depositsFundersBackfile' in value) || value['depositsFundersBackfile'] === undefined) return false;
    if (!('depositsUpdatePoliciesCurrent' in value) || value['depositsUpdatePoliciesCurrent'] === undefined) return false;
    if (!('depositsLicensesCurrent' in value) || value['depositsLicensesCurrent'] === undefined) return false;
    return true;
}
...
export function FlagsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Flags {
    ...
    return {
        ...
        'depositsAbstractsCurrent': json['deposits-abstracts-current'],
        'depositsOrcidsCurrent': json['deposits-orcids-current'],
        'deposits': json['deposits'],
        'depositsAffiliationsBackfile': json['deposits-affiliations-backfile'],
        'depositsUpdatePoliciesBackfile': json['deposits-update-policies-backfile'],
        'depositsAwardNumbersCurrent': json['deposits-award-numbers-current'],
        'depositsResourceLinksCurrent': json['deposits-resource-links-current'],
        'depositsRorIdsCurrent': json['deposits-ror-ids-current'],
        'depositsArticles': json['deposits-articles'],
        'depositsAffiliationsCurrent': json['deposits-affiliations-current'],
        'depositsFundersCurrent': json['deposits-funders-current'],
        'depositsReferencesBackfile': json['deposits-references-backfile'],
        'depositsRorIdsBackfile': json['deposits-ror-ids-backfile'],
        'depositsAbstractsBackfile': json['deposits-abstracts-backfile'],
        'depositsLicensesBackfile': json['deposits-licenses-backfile'],
        'depositsAwardNumbersBackfile': json['deposits-award-numbers-backfile'],
        'depositsDescriptionsCurrent': json['deposits-descriptions-current'],
        'depositsReferencesCurrent': json['deposits-references-current'],
        'depositsResourceLinksBackfile': json['deposits-resource-links-backfile'],
        'depositsDescriptionsBackfile': json['deposits-descriptions-backfile'],
        'depositsOrcidsBackfile': json['deposits-orcids-backfile'],
        'depositsFundersBackfile': json['deposits-funders-backfile'],
        'depositsUpdatePoliciesCurrent': json['deposits-update-policies-current'],
        'depositsLicensesCurrent': json['deposits-licenses-current'],
    };
}
...
export function FlagsToJSONTyped(value?: Flags | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'deposits-abstracts-current': value['depositsAbstractsCurrent'],
        'deposits-orcids-current': value['depositsOrcidsCurrent'],
        'deposits': value['deposits'],
        'deposits-affiliations-backfile': value['depositsAffiliationsBackfile'],
        'deposits-update-policies-backfile': value['depositsUpdatePoliciesBackfile'],
        'deposits-award-numbers-current': value['depositsAwardNumbersCurrent'],
        'deposits-resource-links-current': value['depositsResourceLinksCurrent'],
        'deposits-ror-ids-current': value['depositsRorIdsCurrent'],
        'deposits-articles': value['depositsArticles'],
        'deposits-affiliations-current': value['depositsAffiliationsCurrent'],
        'deposits-funders-current': value['depositsFundersCurrent'],
        'deposits-references-backfile': value['depositsReferencesBackfile'],
        'deposits-ror-ids-backfile': value['depositsRorIdsBackfile'],
        'deposits-abstracts-backfile': value['depositsAbstractsBackfile'],
        'deposits-licenses-backfile': value['depositsLicensesBackfile'],
        'deposits-award-numbers-backfile': value['depositsAwardNumbersBackfile'],
        'deposits-descriptions-current': value['depositsDescriptionsCurrent'],
        'deposits-references-current': value['depositsReferencesCurrent'],
        'deposits-resource-links-backfile': value['depositsResourceLinksBackfile'],
        'deposits-descriptions-backfile': value['depositsDescriptionsBackfile'],
        'deposits-orcids-backfile': value['depositsOrcidsBackfile'],
        'deposits-funders-backfile': value['depositsFundersBackfile'],
        'deposits-update-policies-current': value['depositsUpdatePoliciesCurrent'],
        'deposits-licenses-current': value['depositsLicensesCurrent'],
    };
}
