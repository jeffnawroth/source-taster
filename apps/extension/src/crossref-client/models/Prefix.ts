...
/**
 * Check if a given object implements the Prefix interface.
 */
export function instanceOfPrefix(value: object): value is Prefix {
...
export function PrefixToJSON(json: any): Prefix {
    return PrefixToJSONTyped(json, false);
}

export function PrefixToJSONTyped(value?: Prefix | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
