...
/**
 * Check if a given object implements the WorkInstitution interface.
 */
export function instanceOfWorkInstitution(value: object): value is WorkInstitution {
...
export function WorkInstitutionToJSON(json: any): WorkInstitution {
    return WorkInstitutionToJSONTyped(json, false);
}

export function WorkInstitutionToJSONTyped(value?: WorkInstitution | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
