 ...
 */
export function instanceOfAgency(value: object): value is Agency {
...
export function AgencyToJSON(json: any): Agency {
    return AgencyToJSONTyped(json, false);
}

export function AgencyToJSONTyped(value?: Agency | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
